...
/* harmony export */ });
/* harmony import */ var _manageTask__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./manageTask */ "./src/components/manageTask.js");
...
const renderTask = () => {
    ...
    if (localStorage.getItem('tasks').length > 2) {
        ...
        for (let i = 0; i < taskArr.length; i++) {
            ...
            const priorityOutput = {'high': 'High Priority', 'medium': 'Medium Priority', 'low': 'Low Priority'}
            ...
            deleteTask.addEventListener('click', ()=>{(0,_manageTask__WEBPACK_IMPORTED_MODULE_0__.removeTask)(i)}); 
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_manageTask__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/manageTask */ "./src/components/manageTask.js");
/* harmony import */ var _components_renderTask__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/renderTask */ "./src/components/renderTask.js");
...
const initiateWebsite = () => {
    ...
    document.querySelector('#addBtn').addEventListener('click', _components_manageTask__WEBPACK_IMPORTED_MODULE_0__.addTask);
    document.querySelector('#form1').addEventListener('submit', _components_manageTask__WEBPACK_IMPORTED_MODULE_0__.saveTask);
